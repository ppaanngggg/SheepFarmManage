...
class CMainWindow(QWidget):
    def __init__(self, parent=None):
        ...
        if self.login_database() == True:
            ...
            self.button_add_from_sheet.clicked.connect(self.button_add_from_sheet_clicked)
    ...
    def button_add_from_sheet_clicked(self):
        str_path, str_filter = QFileDialog.getOpenFileName(self, '从表格导入数据', '', '(*.xlsx | *.xls)')
    ...
    def button_sheet_ZHONG_MU_YANG_HOU_YI_clicked(self):
        self.sheet_ZHONG_MU_YANG_HOU_YI_dialog = CSheet_ZHONG_MU_YANG_HOU_YI_Dialog(self)

    def button_sheet_ZHONG_GONG_YANG_HOU_YI_clicked(self):
        self.sheet_ZHONG_GONG_YANG_HOU_YI_dialog = CSheet_ZHONG_GONG_YANG_HOU_YI_Dialog(self)
